#Fetching Cruid Oil data using Web Scrapping for using in sentiment analysis in Vader
...
news_df.to_csv("23-CrudeOil_News_Articles  Data got from Web Scrapping.csv",index=False)      #saving the file to local drive